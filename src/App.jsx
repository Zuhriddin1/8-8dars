    ...
    <>
      <header>
        <div className="flex justify-center gap-10 mt-5 mb-5">
          <p>
            <NavLink to="/12H">12H</NavLink>
          </p>
          <p>
            <NavLink to="/1D">1D</NavLink>
          </p>
          <p>
            <NavLink to="/1W">1W</NavLink>
          </p>
          <p>
            <NavLink to="/1M">1M</NavLink>
          </p>
          <p>
            <NavLink to="/1Y">1Y</NavLink>
          </p>
          <p>
            <NavLink to="/2Y">2Y</NavLink>
          </p>
          <p>
            <NavLink to="/5Y">5Y</NavLink>
          </p>
          <p>
            <NavLink to="/10Y">10Y</NavLink>
          </p>
        </div>
      </header>
      <Routes>
